...
function verificarLogin() {
    if (localStorage.getItem('chico_motoboy_auth') === SENHA) return true;
    const input = prompt('🔒 Senha do Motoboy:');
    if (input === SENHA) { localStorage.setItem('chico_motoboy_auth', SENHA); return true; }
